...
namespace RoadArchitect
{
    ...
    {
        /*
        public Material road = null;
        public Material overlay = null;
        public Material yellow = null;
        public Material tire = null;
        public Material yellow_4 = null;
        public Material tire_4 = null;
        public Material yellow_6 = null;
        public Material tire_6 = null;
        public Material shoulder = null;
        public Material dirt_road = null;
        public Material brick_road = null;
        public Material cobble_road = null;
        public PhysicMaterial pavement = null;
        public PhysicMaterial dirt = null;
        */
        ...
        public bool DetectInvalidDefaultMatsForUndo()
        {
            ...
            Material tMat2Lanes = Resources.Load<Material>("/Materials/Markers/WhiteYellowDouble");
            Material tMat4Lanes = Resources.Load<Material>("/Materials/Markers/WhiteYellowDouble-4L");
            Material tMat6Lanes = Resources.Load<Material>("/Materials/Markers/WhiteYellowDouble-6L");
        ...
        private void CheckMats()
        {
            if (!RoadMaterial1)
            {
                RoadMaterial1 = Resources.Load<Material>("Materials/Road1");
                RoadMaterial2 = Resources.Load<Material>("Materials/Markers/RoadDetailOverlay1");
            }
            ...
            if (!RoadMaterialMarker1)
            {
                if (laneAmount == 2)
                {
                    RoadMaterialMarker1 = Resources.Load<Material>("Materials/Markers/WhiteYellowDouble");
                    RoadMaterialMarker2 = Resources.Load<Material>("Materials/Markers/TireMarks");
                }
                else if (laneAmount == 4)
                {
                    RoadMaterialMarker1 = Resources.Load<Material>("Materials/Markers/WhiteYellowDouble-4L");
                    RoadMaterialMarker2 = Resources.Load<Material>("Materials/Markers/TireMarks-4L");
                }
                else if (laneAmount == 6)
                {
                    RoadMaterialMarker1 = Resources.Load<Material>("Materials/Markers/WhiteYellowDouble-6L");
                    RoadMaterialMarker2 = Resources.Load<Material>("Materials/Markers/TireMarks-6L");
                }
                else
                {
                    RoadMaterialMarker1 = Resources.Load<Material>("Materials/Markers/WhiteYellowDouble");
            ...
            {
                ShoulderMaterial1 = Resources.Load<Material>("Materials/Shoulder1");
                ShoulderMaterial2 = Resources.Load<Material>("Materials/Markers/RoadDetailOverlay1");
            }

            if (isShouldersEnabled && !RoadPhysicMaterial)
            {
                RoadPhysicMaterial = Resources.Load<PhysicMaterial>("Physics/Pavement");
            }
            if (isShouldersEnabled && !ShoulderPhysicMaterial)
            {
                ShoulderPhysicMaterial = Resources.Load<PhysicMaterial>("Physics/Dirt");
            }
        ...
        public void SetDefaultMats()
        {
            ...
            {
                RoadMaterialMarker1 = Resources.Load<Material>("Materials/DirtRoad");
                RoadMaterial1 = RoadMaterialMarker1;
            }
            else if (roadMaterialDropdown == RoadMaterialDropdownEnum.Brick)
            {
                RoadMaterialMarker1 = Resources.Load<Material>("Materials/BrickRoad");
                RoadMaterial1 = RoadMaterialMarker1;
            }
            else if (roadMaterialDropdown == RoadMaterialDropdownEnum.Cobblestone)
            {
                RoadMaterialMarker1 = Resources.Load<Material>("Materials/CobblestoneRoad");
                RoadMaterial1 = RoadMaterialMarker1;
            }
